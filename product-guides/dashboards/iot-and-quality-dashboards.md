...
> _This flexibility allows teams to focus analysis on the assets most relevant to their investigation._
{% endstep %}
...
> _These options allow process data to be displayed in the format most appropriate for operational monitoring._
{% endstep %}
{% endstepper %}
...
> _This ensures the dashboard remains aligned with changing production and quality priorities._
